...
- doc_id: %s
- language: %s
- 内容被分成多个分页。每个分页末尾有行号标记，格式如 [L23-L45]。
...
2. For each chunk, generate a concise summary capturing its semantic essence.
3. Generate a short, descriptive title for each chunk, based on its main topic.
  ...
  "chunks": [
    {
      ...
      "metadata": {
        ...
        "summary": "concise summary of semantic meaning",
