...
func Check(cache SemanticCache, logger logging.Logger, metrics core.Metrics) pipeline.Step[*core.State] {
	if logger == nil {
...
func (s *check) Execute(ctx context.Context, state *core.State) error {
...
func Store(cache SemanticCache, logger logging.Logger, metrics core.Metrics) pipeline.Step[*core.State] {
	if logger == nil {
		logger = logging.NewNoopLogger()
	}
...
func (s *store) Execute(ctx context.Context, state *core.State) error {
