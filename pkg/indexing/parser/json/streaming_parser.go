...
var _ core.Parser = (*JsonStreamParser)(nil)

// JsonStreamParser implements the core.Parser interface for JSON files
...
func (p *JsonStreamParser) ParseStream(ctx context.Context, r io.Reader, metadata map[string]any) (<-chan *core.Document, error) {
...
func (p *JsonStreamParser) Parse(ctx context.Context, content []byte, metadata map[string]any) (*core.Document, error) {
...
func (p *JsonStreamParser) Supports(contentType string) bool { return true }
