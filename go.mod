module github.com/DotNetAge/gorag
...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/milvus v0.41.0
	github.com/testcontainers/testcontainers-go/modules/qdrant v0.41.0
	github.com/testcontainers/testcontainers-go/modules/weaviate v0.41.0
	github.com/unidoc/unioffice v1.39.0
	github.com/weaviate/weaviate v1.36.9
