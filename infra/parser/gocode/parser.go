...
func (p *Parser) Parse(ctx context.Context, r io.Reader) ([]entity.Chunk, error) {
	...
	err := p.ParseWithCallback(ctx, r, func(chunk entity.Chunk) error {
...
func (p *Parser) parseLineByLine(ctx context.Context, r io.Reader, callback func(entity.Chunk) error) error {
...
func (p *Parser) chunkText(ctx context.Context, text string, callback func(entity.Chunk) error) error {
	if len(text) == 0 {
		return nil
	}
...
func (p *Parser) createChunk(content string, position int, elementType string) entity.Chunk {
