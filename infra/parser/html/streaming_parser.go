...
var _ dataprep.Parser = (*HtmlStreamParser)(nil)

// HtmlStreamParser implements the dataprep.Parser interface for HTML
...
func (p *HtmlStreamParser) ParseStream(ctx context.Context, r io.Reader, metadata map[string]any) (<-chan *entity.Document, error) {
