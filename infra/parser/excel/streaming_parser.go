...
var _ dataprep.Parser = (*ExcelStreamParser)(nil)
...
func (p *ExcelStreamParser) ParseStream(ctx context.Context, r io.Reader, metadata map[string]any) (<-chan *entity.Document, error) {
