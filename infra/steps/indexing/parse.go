...
func Multi(parsers ...dataprep.Parser) pipeline.Step[*indexing.State] {
...
func (s *multi) selectParser(filePath string) (dataprep.Parser, error) {
...
func (s *multi) Execute(ctx context.Context, state *indexing.State) error {
	if len(s.parsers) == 0 {
