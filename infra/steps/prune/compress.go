...
func Compress(llm core.Client, logger logging.Logger, metrics abstraction.Metrics, maxTokens int) pipeline.Step[*entity.PipelineState] {
	if maxTokens <= 0 {
		maxTokens = 300
	}
	if logger == nil {
...
func (s *compress) Execute(ctx context.Context, state *entity.PipelineState) error {
...
func (s *compress) flattenChunks(chunks [][]*entity.Chunk) []*entity.Chunk {
	var all []*entity.Chunk
