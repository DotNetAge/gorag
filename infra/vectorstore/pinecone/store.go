...
func (s *Store) buildMetadata(v *entity.Vector) (*pinecone.Metadata, error) {
...
func (s *Store) parseMatches(matches []*pinecone.ScoredVector) ([]*entity.Vector, []float32, error) {
	...
	for _, match := range matches {
		...
		vec := entity.NewVector(id, nil, chunkID, metadata)
