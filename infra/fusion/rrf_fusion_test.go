...
func TestRRFFusionEngine_ReciprocalRankFusion_SingleResultSet(t *testing.T) {
	...
	chunk1 := &entity.Chunk{ID: "chunk1", Content: "Content 1"}
	chunk2 := &entity.Chunk{ID: "chunk2", Content: "Content 2"}
	chunk3 := &entity.Chunk{ID: "chunk3", Content: "Content 3"}
...
func TestRRFFusionEngine_ReciprocalRankFusion_MultipleResultSets(t *testing.T) {
	...
	chunk2 := &entity.Chunk{ID: "chunk2", Content: "Content 2"}
	chunk3 := &entity.Chunk{ID: "chunk3", Content: "Content 3"}
	chunk4 := &entity.Chunk{ID: "chunk4", Content: "Content 4"}
...
func TestRRFFusionEngine_Limit(t *testing.T) {
	...
	chunks := []*entity.Chunk{chunk1, chunk2, chunk3}
